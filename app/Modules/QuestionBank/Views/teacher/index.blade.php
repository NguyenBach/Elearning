...
<div class="col-md-12">
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <table class="table table-bordered table-responsive table-hover" id="questionbank-table">
                   <thead>
                       <tr>
                           <th>ID</th>
...
<script type="text/javascript" src="{{ URL::asset('js/scripts/questionbank.datatables.js') }}"></script>
@stop
