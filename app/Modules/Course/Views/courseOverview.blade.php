        ...
        <div class="single_course_content">
            ...
            <table class="table table-striped course_table">
                ...
                @foreach($lessons as $lesson)
                    <tr>
                        <td>
                            <a href="{{route('course::lessonOverview',['courseid'=>$course->id,'lessonid'=>$lesson->id])}}">{{$lesson->title}}</a>
                        </td>
                        <td><?php echo str_split($lesson->summary, 30)[0] ?></td>
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-primary"
                                   href="{{route('course::editlesson',['id'=>$course->id,'lesson'=>$lesson->id])}}">Edit</a>
