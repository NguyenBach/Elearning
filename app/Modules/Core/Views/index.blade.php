                            ...
                            <li>
                                ...
                                <div class="slider_caption slider_right_caption">
                                    ...
                                    <p>It is a long established fact that a reader will be distracted by the readable
                                        ...
                                        that it has a more-or-less normal distribution of letters.Many desktop
                                        publishing packages and web page editors now use Lorem Ipsum as their default
                                        model text, and a search</p>
                                    <a class="slider_btn" href="#">Know More</a>
                                </div>
                            </li>
                            <!-- Start single slider-->
                                    ...
                                    <ul class="news_tab">
                                        <li>
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <a href="#">Contrary to popular belief, Lorem Ipsum is not simply
                                                        random text</a>
                                                    <span class="feed_date">27.02.15</span>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="ourCourse_content">
                        <ul class="course_nav">
                            <?php
                            $ourCourses = new \App\Modules\Course\Model\Course();
                            $ourCourses = $ourCourses->get10FirstCourse();
                            ?>
                            @foreach($ourCourses as $course)
                                <li>
                                    <div class="single_course">
                                        ...
                                        <div class="singCourse_content">
                                            <h3 class="singCourse_title"><a href="#">{{$course->fullname}}</a></h3>
